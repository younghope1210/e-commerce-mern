...
const Collection = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <header className="text-center">
      <h2 className="text-xl font-bold text-gray-900 sm:text-3xl">Best Collection</h2>
    ...
    <ul className="mt-8 grid grid-cols-2 gap-8 lg:grid-cols-3">
      <li>
        <a href="#" className="group relative block">
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
            <h3 className="md:text-xl font-medium text-white ">cloud-like scent</h3>
      ...
      <li>
        <a href="#" className="group relative block">
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
            <h3 className="md:text-xl font-medium text-white ">Your scent that delivers spring</h3>
      ...
      <li className="lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-1">
        <a href="#" className="group relative block">
          ...
          <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
            <h3 className="md:text-xl font-medium text-white">wear flowers</h3>
